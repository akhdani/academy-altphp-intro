...
abstract class Alt_Websocket {
    protected $userClass = 'Alt_Websocket_User'; // redefine this if you want a custom user class.  The custom user class should inherit from WebSocketUser.
