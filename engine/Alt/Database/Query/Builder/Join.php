...
/**
 * Alt_Database query builder for JOIN statements. See [Query Builder](/Alt_Database/query/builder) for usage and examples.
 *
 ...
 */
class Alt_Database_Query_Builder_Join extends Alt_Database_Query_Builder {
	...
	public function on($c1, $op, $c2)
	{
		...
		{
			throw new Alt_Exception('JOIN ... ON ... cannot be combined with JOIN ... USING ...');
		}
...
} // End Alt_Database_Query_Builder_Join
