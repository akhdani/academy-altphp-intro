...
/**
 * Alt_Database query builder for SELECT statements. See [Query Builder](/Alt_Database/query/builder) for usage and examples.
 *
 ...
 */
class Alt_Database_Query_Builder_Select extends Alt_Database_Query_Builder_Where {
	...
	{
		$this->_join[] = $this->_last_join = new Alt_Database_Query_Builder_Join($table, $type);
	 ...
	 *  must be an instance of Alt_Database_Query_Builder_Select
	...
	public function union($select, $all = TRUE)
	{
		...
		if ( ! $select instanceof Alt_Database_Query_Builder_Select)
			throw new Alt_Exception('first parameter must be a string or an instance of Alt_Database_Query_Builder_Select');
