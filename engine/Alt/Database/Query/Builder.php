...
/**
 * Alt_Database query builder. See [Query Builder](/Alt_Database/query/builder) for usage and examples.
 *
 ...
 */
abstract class Alt_Database_Query_Builder extends Alt_Database_Query {
	 ...
	 * @return  string
	 */
	protected function _compile_join(Alt_Database $db, array $joins)
	{
		$statements = array();
	 ...
	 * @return  string
	 */
	protected function _compile_conditions(Alt_Database $db, array $conditions)
	{
		$last_condition = NULL;
		...
		foreach ($conditions as $group)
		{
			...
			foreach ($group as $logic => $condition)
			{
				...
				else
				{
					...
					// Alt_Database operators are always uppercase
					$op = strtoupper($op);
	 ...
	 * @return  string
	 */
	protected function _compile_set(Alt_Database $db, array $values)
	{
		$set = array();
	 ...
	 * @return  string
	 */
	protected function _compile_group_by(Alt_Database $db, array $columns)
	{
		$group = array();
...
} // End Alt_Database_Query_Builder
